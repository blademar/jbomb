...
public class Explosion {
    ...
    public Explosion(SimpleApplication app) {
    ...
    private void createFlame(){
        ...
        mat.setTexture("Texture", assetManager.loadTexture("textures/explosion/flame.png"));
    ...
    private void createFlash(){
        ...
        flash.setImagesY(2);
        Material mat = new Material(assetManager, "Common/MatDefs/Misc/Particle.j3md");
        mat.setTexture("Texture", assetManager.loadTexture("textures/explosion/flash.png"));
        mat.setBoolean("PointSprite", POINT_SPRITE);
    ...
    private void createRoundSpark(){
        ...
        Material mat = new Material(assetManager, "Common/MatDefs/Misc/Particle.j3md");
        mat.setTexture("Texture", assetManager.loadTexture("textures/explosion/roundspark.png"));
        mat.setBoolean("PointSprite", POINT_SPRITE);
    ...
    private void createSpark(){
        ...
        spark.setImagesY(1);
        Material mat = new Material(assetManager, "Common/MatDefs/Misc/Particle.j3md");
        mat.setTexture("Texture", assetManager.loadTexture("textures/explosion/spark.png"));
...
//        smoketrail.setShape(new EmitterSphereShape(Vector3f.ZERO, 1f));
        ...
        Material mat = new Material(assetManager, "Common/MatDefs/Misc/Particle.j3md");
        mat.setTexture("Texture", assetManager.loadTexture("textures/explosion/smoketrail.png"));
...
//        debris.setShape(new EmitterSphereShape(Vector3f.ZERO, .05f));
        ...
        debris.setImagesY(3);
        Material mat = new Material(assetManager, "Common/MatDefs/Misc/Particle.j3md");
        mat.setTexture("Texture", assetManager.loadTexture("textures/explosion/Debris.png"));
...
//        shockwave.setRandomAngle(true);
        ...
        Material mat = new Material(assetManager, "Common/MatDefs/Misc/Particle.j3md");
        mat.setTexture("Texture", assetManager.loadTexture("textures/explosion/shockwave.png"));
