...
public class GeometryUtils {
    ...
    public Geometry makePlane(float x, float y, String name, String texturePath, Vector3f localTranslation, Quaternion quaternion, Vector2f scaleTexture, boolean transparent) {
    ...
    public Geometry makePlane(float x, float y, String name, String texturePath, Vector3f localTranslation, Quaternion quaternion, Vector2f scaleTexture) {
        return makePlane(x, y, name, texturePath, localTranslation, quaternion, scaleTexture, false);
    }
    
    public Geometry makePlane(float x, float y, String name, String texturePath, Vector3f localTranslation, Quaternion quaternion, boolean transparent) {
        return makePlane(x, y, name, texturePath, localTranslation, quaternion, null, transparent);
    }

    public Geometry makePlane(float x, float y, String name, String texturePath, Quaternion quaternion, Vector3f localTranslation) {
        return makePlane(x, y, name, texturePath, localTranslation, quaternion, null, false);
    }  
    
    public Geometry makePlane(float x, float y, String name, String texturePath, Vector3f localTranslation) {
        return makePlane(x, y, name, texturePath, localTranslation, null, null, false);
    } 
    
    public Geometry makePlane(float x, float y, String name, String texturePath, Vector3f localTranslation, Vector2f scaleTexture) {
        return makePlane(x, y, name, texturePath, localTranslation, null, scaleTexture, false);
    }
    
    public Geometry makePlane(float x, float y, String name, String texturePath, Vector3f localTranslation, boolean transparent) {
        return makePlane(x, y, name, texturePath, localTranslation, null, null, transparent);
    }
    
    public Geometry makePlane(float x, float y, String name, String texturePath, Vector3f localTranslation, Vector2f scaleTexture, boolean transparent) {
