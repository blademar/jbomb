...
//        makeWall(-10, 2, 20, "w_gray1.png", "w_green3.png", separation);
        ...
        makePlaneXY(20f, 20.2f, "north_glass", "textures/glass/sunbeam_t.png", new Vector3f(0f, 20f, -20f), true);
        makePlaneXY(20f, 20.2f, "south_glass", "textures/glass/sunbeam_t.png", new Vector3f(0f, 20f, 20f), true);
        makePlaneYZ(20.2f, 20.2f, "west_glass", "textures/glass/sunbeam_t.png", new Vector3f(-20f, 20f, 0f), true);
        makePlaneYZ(20.2f, 20.2f, "east_glass", "textures/glass/sunbeam_t.png", new Vector3f(20f, 20f, 0f), true);
        makePlaneXZ(20f, 20f, "up_glass", "textures/glass/sunbeam_t.png", new Vector3f(0f, 40f, 0f), true);
    }
